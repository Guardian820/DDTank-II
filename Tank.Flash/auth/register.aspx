...
<body style="background: url(../images/popup.png) no-repeat scroll 0pt 0pt transparent;">
   ...
   <table style="width: 100%;">
                             ...
                             <span id="lbError" style="color:Red;" ></span><br />
                                    ...
                                    <tr>
                                        <td class="style8">
                                           <span  style="font-size: 14px; color: #F60; font-weight: bold;">Tài khoản：</span>
                                        </td>
                                        <td class="style9">
                                    ...
                                    <tr>
                                        <td class="style8">
                                           <span  style="font-size: 14px; color: #F60; font-weight: bold;">Mật khẩu：</span>
                                        </td>
                                        <td class="style9">
                                    ...
                                    <tr>
                                        <td class="style8">
                                           <span  style="font-size: 14px; color: #F60; font-weight: bold;">Xác nhận mật khẩu：</span></td>
                                        <td class="style9">
                                           <input type="password" class="user_input" value="" name="repassword" /></td>
                                    </tr>
                                    <tr>
                                        <td class="style8">
                                           <span  style="font-size: 14px; color: #F60; font-weight: bold;">Email：</span>
                                        </td>
                                        <td class="style9">
                                    ...
                                    <tr>
                                        <td class="style8">
                                            <span  style="font-size: 14px; color: #F60; font-weight: bold;">Mã bảo vệ:&nbsp;&nbsp;&nbsp; </span>
                                            </td>
                                        <td class="style9">
                                    ...
                                    <tr>
                                        <td class="style11">
                                           <span  style="font-size: 14px; color: #F60; font-weight: bold;">Nhập mã bảo vệ：</span>
                                           </td>
                                        <td class="style12">
