    ...
    public class ConsortiaBussiness : BaseBussiness
    {
            ...
            try
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    infos.Add(new ConsortiaInfo
                    {
                        ...
                        ChairmanTypeVIP = Convert.ToByte(dr["typeVIP"]),
                        ChairmanVIPLevel = (int)dr["VIPLevel"],
        ...
        public bool UpdateConsortiaRiches(int consortiaID, int userID, int Riches, ref string msg)
        {
            ...
            try
            {
                ...
                result = this.db.RunProcedure("SP_ConsortiaRiches_Update", para);
        ...
        public bool UpdateConsortiaChairman(string nickName, int consortiaID, int userID, ref string msg, ref ConsortiaDutyInfo info, ref int tempUserID, ref string tempUserName)
        {
            ...
            try
            {
                ...
                para[5] = new SqlParameter("@tempUserName", SqlDbType.VarChar, 100);
                ...
                para[7] = new SqlParameter("@tempDutyName", SqlDbType.VarChar, 100);
        ...
        public ConsortiaInfo GetConsortiaSingleByName(string ConsortiaName)
        {
            ...
            try
            {
                ...
                this.db.GetReader(ref reader, "SP_Consortia_CheckByName", para);
                if (reader.Read())
                {
        ...
        public bool UpGradeSkillConsortia(int consortiaID, int userID, ref string msg)
        {
            ...
            try
            {
                ...
                para[2].Direction = ParameterDirection.ReturnValue;
                this.db.RunProcedure("SP_Consortia_Skill_UpGrade", para);
                int returnValue = (int)para[2].Value;
                result = (returnValue == 0);
                switch (returnValue)
                {
            ...
            try
            {
                ...
                if (reader.Read())
                {
                    return new ConsortiaInfo
                    {
                        ...
                        ChairmanID = (int)reader["ChairmanID"],
                        ChairmanName = reader["ChairmanName"].ToString(),
                        ChairmanTypeVIP = Convert.ToByte(reader["typeVIP"]),
                        ChairmanVIPLevel = (int)reader["VIPLevel"],
                        ConsortiaName = reader["ConsortiaName"].ToString(),
                        CreatorID = (int)reader["CreatorID"],
                        CreatorName = reader["CreatorName"].ToString(),
                        Description = reader["Description"].ToString(),
        ...
        public bool ScanConsortia(ref string noticeID)
        {
            ...
            try
            {
                ...
                para[0] = new SqlParameter("@NoticeID", SqlDbType.NVarChar, 4000);
            ...
            try
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    infos.Add(new ConsortiaApplyUserInfo
                    {
                        ...
                        typeVIP = (int)dr["typeVIP"],
                        Win = (int)dr["Win"],
                        Total = (int)dr["Total"],
                        Repute = (int)dr["Repute"],
                        FightPower = (int)dr["FightPower"],
                        IsOld = (bool)dr["IsOldPlayer"],
                        Offer = (int)dr["Offer"]
                    });
                }
            }
        ...
        public bool DeleteConsortiaUser(int userID, int kickUserID, int consortiaID, ref string msg, ref string nickName)
        {
            ...
            try
            {
                ...
                para[3] = new SqlParameter("@Result", SqlDbType.Int);
                para[3].Direction = ParameterDirection.ReturnValue;
                para[4] = new SqlParameter("@NickName", SqlDbType.VarChar, 200);
                para[4].Direction = ParameterDirection.InputOutput;
        ...
        public ConsortiaEquipControlInfo GetConsortiaEuqipRiches(int consortiaID, int Level, int type)
        {
            ...
            try
            {
                ...
                if (reader.Read())
                {
                    ...
                    ConsortiaEquipControlInfo result = info;
                    return result;
                }
            }
            catch (Exception e)
