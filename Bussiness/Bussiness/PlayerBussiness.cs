    ...
    public class PlayerBussiness : BaseBussiness
    {
        ...
        public bool ActivePlayer(ref PlayerInfo player, string userName, string passWord, bool sex, int gold, int money, string IP, string site)
        {
            ...
            try
            {
                ...
                player.Defence = 0;
                player.Gold = 10000;//set vang
                player.GP = 1;//set gp
                player.Grade = 1;
                player.ID = 0;
                player.Luck = 0;
                player.Money = 10000;//set xu
                player.NickName = "";
                player.Sex = sex;
                player.State = 0;
                player.Style = ",,,,,,";
        ...
        public bool UpdatePlayer(PlayerInfo player)
        {
            ...
            try
            {
                ...
                para[14] = new SqlParameter("@ExpendDate", player.ExpendDate == null ? DateTime.Now : player.ExpendDate);//fix luu do
                ...
                para[58] = new SqlParameter("@lastLuckyNumDate", player.lastLuckyNumDate);//fix luu do
                ...
                para[66] = new SqlParameter("@LastRefreshPet", player.LastRefreshPet);//fix luu do
                ...
                para[71] = new SqlParameter("@TimeBox", player.TimeBox);//.ToString());//fix luu do
        ...
        public bool UpdateGoods(ItemInfo item)
        {
            ...
            try
            {
                SqlParameter[] para = new SqlParameter[]
				{
                    ...
                    new SqlParameter("@goldBeginTime", item.goldBeginTime),//fix luu do
                    ...
                    new SqlParameter("@latentEnergyEndTime", item.latentEnergyEndTime),//fix luu do
        ...
        public bool UpdateUserTexpInfo(TexpInfo info)
        {
            ...
            try
            {
                SqlParameter[] para = new SqlParameter[]
				{
                    ...
                    new SqlParameter("@texpTaskDate", info.texpTaskDate),//fix luu do
					new SqlParameter("@Result", SqlDbType.Int)
				};
        ...
        public bool AddFarm(UserFarmInfo item)
        {
            ...
            try
            {
                SqlParameter[] para = new SqlParameter[]
				{
                    ...
                    new SqlParameter("@AutoPayTime", item.AutoPayTime),//fix luu do
        ...
        public bool UpdateFarm(UserFarmInfo info)
        {
            ...
            try
            {
                SqlParameter[] para = new SqlParameter[]
				{
                    ...
                    new SqlParameter("@AutoPayTime", info.AutoPayTime),//fix luu do
